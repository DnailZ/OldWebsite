...
The only file you need to download is `BitenArifact.ova`, you can download this file from [OneDrive](https://purdue0-my.sharepoint.com/:u:/g/personal/ding360_purdue_edu/Ebv7XMQfWDxNnEMVBU-y8tkBL_sWUxQF4l8MN3tAPv94Cg?e=dDN3if). The image can be loaded by VirtualBox 7.
